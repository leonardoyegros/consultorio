...
<a href="#" topbar="1" class="btn btn-default pull-left delete-multiple-index" data-toggle="tooltip" data-placement="bottom" data-original-title="" title="<?php __("Remove Seleted")?>"><span class="glyphicon glyphicon-remove"></span></a>
