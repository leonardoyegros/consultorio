<?php 
    echo $this->Html->link('',array('controller'=>'documents', 'action'=>'add'), array('topbar'=>true, 'icon'=>'plus','data-toggle'=>"tooltip"));;
?>
...
<a href="#" url="http://www.getsiso.com/listar-documentos/" topbar="1" class="btn btn-default pull-left help" data-toggle="tooltip" data-placement="bottom"  data-original-title="" title="<?php echo __("Help", true) ?>"><span class="glyphicon glyphicon-question-sign"></span></a>
